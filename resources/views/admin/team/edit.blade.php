    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br/>
                    <form action="{{ route("admin.team.update",["id"=>$team[0]["id"]]) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <img src="{{ asset("imagesWebp/team/")."/".$team[0]["imageWebp"] }}" width="150" alt="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" id="name" name="name" required="required"
                                       class="form-control col-md-7 col-xs-12" value="{{ $team[0]["name"] }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" id="job" name="job" required="required"
                                       class="form-control col-md-7 col-xs-12" value="{{ $team[0]["job"] }}"
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                <button type="submit" class="btn btn-success">人物アップデート <span
